...
API desenvolvida com NestJS para gerenciamento de usuários, com autenticação, validações e segurança de dados.
...
### CreateUsuarioDto
> Utiliza o Class-validator para realizar a validação dos campos de entrada
> 
- Email válido (`@IsEmail`)
- Senha forte (`@MinLength`,`@MaxLength`, `@Matches`)
- CPF com 11 dígitos (`@Matches`)
- Nome obrigatório
- Tipo de usuário (`@IsEnum`)
